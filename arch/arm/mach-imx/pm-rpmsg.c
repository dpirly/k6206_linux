...
static int pm_rpmsg_probe(struct rpmsg_channel *rpdev)
{
	int ret;
...
static void pm_rpmsg_cb(struct rpmsg_channel *rpdev,
...
static void pm_rpmsg_remove(struct rpmsg_channel *rpdev)
{
