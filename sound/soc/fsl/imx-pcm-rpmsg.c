...
static void i2s_rpmsg_cb(struct rpmsg_channel *rpdev, void *data, int len,
						void *priv, u32 src)
{
...
static int i2s_rpmsg_probe(struct rpmsg_channel *rpdev)
{
...
static void i2s_rpmsg_remove(struct rpmsg_channel *rpdev)
{
