...
static void rpmsg_regulator_cb(struct rpmsg_channel *rpdev, void *data, int len,
						void *priv, u32 src)
{
...
static int rpmsg_regulator_probe(struct rpmsg_channel *rpdev)
{
...
static void rpmsg_regulator_remove(struct rpmsg_channel *rpdev)
{
